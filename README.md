...
note if you want to deploy the backend locally go to Question--->src--->app--->auth.service.ts---> comment the baseurl which is worked and remove the comment on the local baseurl and save it 
